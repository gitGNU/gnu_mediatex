...
cp $GITCLT/$MDTXUSER-coll1$EXTRFILE $GITCLT/$MDTXUSER-coll3$EXTRFILE
cp $GITCLT/$MDTXUSER-coll1$EXTRFILE $GITCLT/$MDTXUSER-coll4$EXTRFILE
...
cp $GITCLT/$MDTXUSER-coll1$SERVFILE $GITCLT/$MDTXUSER-coll4$SERVFILE

cp $GITCLT/$MDTXUSER-coll1$CATHFILE $GITCLT/$MDTXUSER-coll4$CATHFILE
